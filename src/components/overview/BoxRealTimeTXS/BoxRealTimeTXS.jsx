...
const TableComponent = ({ title, columns, data }) => {
  ...
  return (
    <div className="w-full h-[583px] mx-auto p-2 rounded-md shadow-sm border border-gray-200">
      <div className="w-full h-full relative bg-white rounded-2xl  overflow-hidden">
        {/* Header */}
        <div className="px-2 pb-5  from-blue-50 via-indigo-50 to-purple-50 border-b border-gray-200">
            ...
            <thead>
              <tr className="bg-gray-50/80">
                {columns?.map((col, index) => (
                  <th
                    key={index}
                    className={` py-2 text-start text-xs font-bold  uppercase tracking-wider border-b border-gray-200 ${
